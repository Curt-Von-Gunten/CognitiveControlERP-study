...
SlowWavedat = read.delim("C:/Users/Curt/Box Sync/Bruce Projects/Sequential Processing/PointByPoint Processing/Created by R_ArtRej/SlowWave/137_TBT_SlowWave_Cond_10subs.txt", header=T)
...
SlowWavedat$notFirst[SlowWavedat$Subject == 137 & SlowWavedat$Trial %in% firstTrials_137] = 0
...
write.table(SlowWave.correct, "Created by R_ArtRej/SlowWave/137_TBTaverages_SlowWave_Correct_withPrevious_10subs.txt", sep = "\t", row.names = F)