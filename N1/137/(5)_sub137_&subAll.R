...
path = "C:/Users/Curt/Box Sync/Bruce Projects/Sequential Processing/PointByPoint Processing/Created by R_ArtRej/SlowWave/"
...
SlowWavedat_All <- rbind(SlowWavedat_10subs, SlowWavedat_short, SlowWavedat_137)
