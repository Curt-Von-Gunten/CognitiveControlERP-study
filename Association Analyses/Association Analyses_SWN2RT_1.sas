...
ods pdf file="C:\Users\cdvrmd\Box Sync\Bruce Projects\Sequential Processing\PointByPoint Processing\Code\Code for Art Rej Data\Association Analyses\Association_Analyses_1.pdf";
...
random intercept SWPrevCent/ sub=Subject; 
estimate 'SWPrevMean'         SWPrevMean 1  SWPrevMean*Cell 1 0 0 0;
estimate 'SWPrevMean'         SWPrevMean 1  SWPrevMean*Cell 0 1 0 0;
estimate 'SWPrevMean'         SWPrevMean 1  SWPrevMean*Cell 0 0 1 0;
estimate 'SWPrevMean'         SWPrevMean 1  SWPrevMean*Cell 0 0 0 1;
estimate 'SWPrevCent'         SWPrevCent 1  SWPrevCent*Cell 1 0 0 0;
estimate 'SWPrevCent'         SWPrevCent 1  SWPrevCent*Cell 0 1 0 0;
estimate 'SWPrevCent'         SWPrevCent 1  SWPrevCent*Cell 0 0 1 0;
estimate 'SWPrevCent'         SWPrevCent 1  SWPrevCent*Cell 0 0 0 1;
run;
*Adding Cell;
proc mixed data=Seq_Eff_MeanCent covtest noinfo noitprint;
...
class Subject Electrode Curr Prev;
model  SWCur_N2_diff = Trial|Curr|Prev;
random intercept / sub=Subject; 
random intercept / sub=Subject(Electrode);
estimate 'Trial Avg Slope'         Trial 1;
run;
