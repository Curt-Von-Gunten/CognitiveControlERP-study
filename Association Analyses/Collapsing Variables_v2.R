...
RT_N2_SlowWave <- read.delim("RT_N2_SlowWave_SlowWavePrev_v.2.txt")
...
write.table(RT_N2_SlowWave_Coll, "RT_N2_SlowWave_SubNoCond.txt", sep = "\t", row.names = F)

#Subject Level with condition.
dat1 <- select(RT_N2_SlowWave2, Subject, Trial, Electrode, Cell, RT, N2Curr, SlowWaveCurr, SlowWavePrev)
dat2 <- group_by(dat1, Subject, Cell)
(RT_N2_SlowWave_Coll <-   summarise(dat2, mean(RT), mean(N2Curr), mean(SlowWaveCurr), mean(SlowWavePrev)))
colnames(RT_N2_SlowWave_Coll) <- c("Subject", "Cell", "RT", "N2Curr", "SlowWaveCurr", "SlowWavePrev")
write.table(RT_N2_SlowWave_Coll, "RT_N2_SlowWave_SubLev.txt", sep = "\t", row.names = F)

#Electrode Level.
dat1 <- select(RT_N2_SlowWave2, Subject, Trial, Electrode, Cell, RT, N2Curr, SlowWaveCurr, SlowWavePrev)
dat2 <- group_by(dat1, Subject, Electrode, Cell)
(RT_N2_SlowWave_Coll <-   summarise(dat2, mean(RT), mean(N2Curr), mean(SlowWaveCurr), mean(SlowWavePrev)))
colnames(RT_N2_SlowWave_Coll) <- c("Subject", "Electrode", "Cell", "RT", "N2Curr", "SlowWaveCurr", "SlowWavePrev")
write.table(RT_N2_SlowWave_Coll, "RT_N2_SlowWave_ElecLev.txt", sep = "\t", row.names = F)
...
write.table(RT_N2_SlowWave_Coll, "RT_N2_SlowWave_TrialLev.txt", sep = "\t", row.names = F)

#Trial Level no condition variable.
dat1 <- select(RT_N2_SlowWave2, Subject, Trial, Electrode, Cell, RT, N2Curr, SlowWaveCurr, SlowWavePrev)
dat2 <- group_by(dat1, Subject, Trial)
(RT_N2_SlowWave_Coll <-   summarise(dat2, mean(RT), mean(N2Curr), mean(SlowWaveCurr), mean(SlowWavePrev)))
colnames(RT_N2_SlowWave_Coll) <- c("Subject", "Trial", "RT", "N2Curr", "SlowWaveCurr", "SlowWavePrev")
write.table(RT_N2_SlowWave_Coll, "RT_N2_SlowWave_TrialLevNoCond.txt", sep = "\t", row.names = F)
...
write.table(RT_N2_SlowWave_Coll, "RT_N2_SlowWave_Trial&ElecLev.txt", sep = "\t", row.names = F)
...
SlowPredN2 <- lm(N2Curr ~ SlowWavePrev, data = RT_N2_SlowWave_Coll)
summary(SlowPredN2)

SlowPredRT <- lm(RT ~ SlowWavePrev, data = RT_N2_SlowWave_Coll)
summary(SlowPredRT)

SlowPredSlow <- lm(RT ~ SlowWaveCurr, data = RT_N2_SlowWave_Coll)
summary(SlowPredSlow)