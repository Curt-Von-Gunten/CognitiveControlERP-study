...
Sub137 <- RT_N2_SlowWave_dat_allERP[RT_N2_SlowWave_dat_allERP$Subject == 137,]
#####################################################################
...
write.table(Alldat, paste(path, "RT_N2_SlowWave_SlowWavePrev_EventFixed.txt", sep=""), sep = "\t", row.names = F)
