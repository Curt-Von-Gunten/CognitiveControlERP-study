...
temp = read.delim("C:/Users/cdvrmd/Box Sync/Bruce Projects/Sequential Processing/PointByPoint Processing/Created by R_ArtRej/SlowWave/AllSubs_TBT_SlowWave.txt", header=T)
...
write.table(QuantDatCondFull, paste(path,"Created by R_ArtRej/SlowWave/AllSubs_TBT_SlowWave_Cond.txt", sep=""), sep = "\t", row.names = F)
