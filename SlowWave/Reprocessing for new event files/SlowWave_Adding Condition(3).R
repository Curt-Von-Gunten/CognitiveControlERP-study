...
temp = read.delim("C:/Users/Curt/Box Sync/Bruce Projects/Sequential Processing/PointByPoint Processing/Created by R_ArtRej/SlowWave/AllSubs_TBT_SlowWave_10subs.txt", header=T)
...
write.table(QuantDatCondFull, paste(path,"Created by R_ArtRej/SlowWave/AllSubs_TBT_SlowWave_Cond_10subs.txt", sep=""), sep = "\t", row.names = F)
