...
sublist <- c("002", "004", "008", "016", "017", "019", "030", "059", "070", "074", "137")
...
write.table(NumAcceptedTrials, paste(path,"Created by R_ArtRej/SlowWave/SlowWave_NumberOfAcceptedTrials_10subs.txt", sep=""), sep = "\t", row.names = F)
