...
temp = read.delim("C:/Users/psycworks/Desktop/Box Sync/Bruce Projects/Sequential Processing/PointByPoint Processing/Created by R_ArtRej/N2/AllSubs_TBT_N2_3Subs.txt", header=T)
...
write.table(QuantDatCondFull, paste(path,"Created by R_ArtRej/N2/AllSubs_TBT_N2_Cond_3subs.txt", sep=""), sep = "\t", row.names = F)
